...
- **WordPress** — Content Management System (CMS) running via PHP‑FPM.  

**Service interaction flow:**

- Nginx acts as the secure entry point and forwards PHP requests to WordPress.  
- WordPress communicates with MariaDB to store and retrieve data.


## 2. Prerequisites & Configuration

Before starting, map the project URL to your localhost. Edit your hosts file:

### Linux  
`cd /etc/hosts`
 then Add: `127.0.0.1 oklimov.42.fr`
...
git clone git@github.com:Alexejklimov/inception_42.git
`cd Inception`
...
`docker ps`
You should see nginx, wordpress (or wordpress), and mariadb running.
